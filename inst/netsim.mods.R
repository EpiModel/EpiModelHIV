...
param <- param_msm(nwstats = st,
                   ...
                   ept.coverage = 0.0,
                   stianntest.gc.hivneg.coverage = 0.34,
                   stianntest.ct.hivneg.coverage = 0.34,
                   stianntest.syph.hivneg.coverage = 0.34, #0.44, # 0.45
                   stihighrisktest.gc.hivneg.coverage = 0.01,
                   stihighrisktest.ct.hivneg.coverage = 0.01,
                   stihighrisktest.syph.hivneg.coverage = 0.01,
                   stianntest.gc.hivpos.coverage = 0.51,
                   stianntest.ct.hivpos.coverage = 0.51,
                   stianntest.syph.hivpos.coverage = 0.51, #0.65, #0.67
                   stihighrisktest.gc.hivpos.coverage = 0.01,
                   stihighrisktest.ct.hivpos.coverage = 0.01,
                   stihighrisktest.syph.hivpos.coverage = 0.01,
