...
param_msm <- function(nwstats,
                      ...
                      rgc.sympt.prob = 0.06789649,
                      ugc.sympt.prob = 0.8443316,
                      rct.sympt.prob = 0.06979015,
                      uct.sympt.prob = 0.9011038,

                      rgc.dur.asympt = 37.76041,
                      ugc.dur.asympt = 34.72606,
                      gc.dur.tx = 2,
                      gc.dur.ntx = NULL,

                      rct.dur.asympt = 44.69662,
                      uct.dur.asympt = 45.3775,
                      ct.dur.tx = 2,
                      ct.dur.ntx = NULL,
