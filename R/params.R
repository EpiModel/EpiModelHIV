...
param_cl <- function(nwstats,
                     ...
                     #adjusted for mixing!
                      ...
                      prep.class.prob.asmm.dist = 0,
                      prep.class.prob.asmm = c(.209, .244, .131, .416), 
                      prep.class.prob.asmm.i1 = c(.048, .225, .169, .558),
                      prep.class.prob.asmm.i2 = c(.369, .263, .093, .273),
                      prep.class.prob.asmm.i3 = c(.209, .244, .131, .416),
                      prep.class.prob.asmm.i4 = c(.0267, .0267, .0267, .92),
                      prep.class.prob.asmm.i5 = c(.093, .092, .092, .723),
                      prep.class.prob.asmm.i6 = c(.143, .142, .142, .573),
                      prep.class.prob.asmm.i7 = c(.17, .198, .104, .528),
...
control_cl <- function(simno = 1,
                        ...
                        save.nwstats = FALSE,
                        save.other = c("attr", "temp", "riskh", "el", "p" , "riskhist" ,"age.inf.vec", "el.age"),
                        verbose = TRUE,
                        verbose.int = 1,
                        ...) {
