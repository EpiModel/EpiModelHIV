...
param_cl <- function(nwstats,
                      ...
                      prep.class.prob.b.asmm = c(.209, .244, .131, .416), 
                      prep.class.prob.w.asmm = c(.209, .244, .131, .416), 
                      #prep.class.effect.asmm = c(0, 0.31, 0.81, 0.95) - replaced by prep.class.hr (the inverse),
                      prep.coverage.b.asmm = .30,
                      prep.coverage.w.asmm = .30,
...
control_cl <- function(simno = 1,
                        ...
                        save.nwstats = FALSE,
                        save.other = c("attr", "temp", "riskh", "el", "p" , "riskhist" ,"age.inf.vec"),
                        verbose = TRUE,
                        verbose.int = 1,
                        ...) {
