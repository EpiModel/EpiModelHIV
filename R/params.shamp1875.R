...
#' @title Epidemic Model Parameters for SHAMP (ages 18-75)
#'
#' @description Sets the epidemic parameters for stochastic network models
#'              simulated with \code{\link{netsim}} for EpiModelHIV (expanded age 18-75)
#'
...
#'
#' @export
param_shamp_1875 <- function(race.method = 1,
                      time.unit = 7,
                      method = 1,
                      age.unit = 52,
...
#' @title Epidemic Model Initial Conditions for SHAMP (18-75)
#'
...
#'
#' @export
init_shamp_1875 <- function(prev.B.f = 0.02,
                     prev.BI.f =0.02,
                     prev.H.f =0.02,
                     prev.HI.f =0.02,
                     prev.W.f = 0.02,
  ...
  p$init.prev.age.slope.B.f <- prev.B.f / 58
  p$init.prev.age.slope.BI.f <- prev.BI.f / 58
  p$init.prev.age.slope.H.f <- prev.H.f / 58
  p$init.prev.age.slope.HI.f <- prev.HI.f / 58
  p$init.prev.age.slope.W.f <- prev.W.f / 58
  p$init.prev.age.slope.B.msf <- prev.B.msf / 58
  p$init.prev.age.slope.BI.msf <- prev.BI.msf / 58
  p$init.prev.age.slope.H.msf <- prev.H.msf / 58
  p$init.prev.age.slope.HI.msf <- prev.HI.msf / 58
  p$init.prev.age.slope.W.msf <- prev.W.msf / 58
  p$init.prev.age.slope.B.msm <- prev.B.msm / 58
  p$init.prev.age.slope.BI.msm <- prev.BI.msm / 58
  p$init.prev.age.slope.H.msm <- prev.H.msm / 58
  p$init.prev.age.slope.HI.msm <- prev.HI.msm / 58
  p$init.prev.age.slope.W.msm <- prev.W.msm / 58
  p$init.prev.age.slope.B.msmf <- prev.B.msmf / 58
  p$init.prev.age.slope.BI.msmf <- prev.BI.msmf / 58
  p$init.prev.age.slope.H.msmf <- prev.H.msmf / 58
  p$init.prev.age.slope.HI.msmf <- prev.HI.msmf / 58
  p$init.prev.age.slope.W.msmf <- prev.W.msmf / 58
...
#'
#' @export
control_shamp_1875 <- function(simno = 1,
                        nsims = 1,
                        ncores = 1,
                        nsteps = 100,
                        start = 1,
                        ...
                        demogupdate.FUN = demogupdate_shamp_1875,
                        test.FUN = test_shamp,
                        tx.FUN = tx_shamp,
                        #prep.FUN = prep_shamp,
