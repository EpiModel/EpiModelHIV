...
#males
    ...
    if(intervention_TM=="TMPNP"){
      ...
      #use background PS test probabilities
      partner.test.prob.tm <- dat$param$partner.test.prob.bl
      ...
      #put partner services testing in the background
      tst.bg <- c(tst.background, tst.prep, tst.ps)
      tst.rna <- c(sym_HIV, sym)
