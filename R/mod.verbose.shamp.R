    ...
    if (x$control$verbose == TRUE) {
      if (!interactive()) {
        ...
        if (verbose.int > 0 && (at %% verbose.int == 0)) {
          ...
          prev <- round(x$epi$prev[at], 3)
          prev.B.f <- round(x$epi$prev.B.f[at], 3)
          prev.BI.f <- round(x$epi$prev.BI.f[at], 3)
          prev.H.f <- round(x$epi$prev.H.f[at], 3)
          prev.HI.f <- round(x$epi$prev.HI.f[at], 3)
          prev.W.f <- round(x$epi$prev.W.f[at], 3)
          
          prev.B.m <- round(x$epi$prev.B.m[at], 3)
          prev.BI.m <- round(x$epi$prev.BI.m[at], 3)
          prev.H.m <- round(x$epi$prev.H.m[at], 3)
          prev.HI.m <- round(x$epi$prev.HI.m[at], 3)
          prev.W.m <- round(x$epi$prev.W.m[at], 3)
          
          prev.B.msf <- round(x$epi$prev.B.msf[at], 3)
          prev.BI.msf <- round(x$epi$prev.BI.msf[at], 3)
          prev.H.msf <- round(x$epi$prev.H.msf[at], 3)
          prev.HI.msf <- round(x$epi$prev.HI.msf[at], 3)
          prev.W.msf <- round(x$epi$prev.W.msf[at], 3)
          
          prev.B.msm <- round(x$epi$prev.B.msm[at], 3)
          prev.BI.msm <- round(x$epi$prev.BI.msm[at], 3)
          prev.H.msm <- round(x$epi$prev.H.msm[at], 3)
          prev.HI.msm <- round(x$epi$prev.HI.msm[at], 3)
          prev.W.msm <- round(x$epi$prev.W.msm[at], 3)
          
          prev.B.msmf <- round(x$epi$prev.B.msmf[at], 3)
          prev.BI.msmf <- round(x$epi$prev.BI.msmf[at], 3)
          prev.H.msmf <- round(x$epi$prev.H.msmf[at], 3)
          prev.HI.msmf <- round(x$epi$prev.HI.msmf[at], 3)
          prev.W.msmf <- round(x$epi$prev.W.msmf[at], 3)
