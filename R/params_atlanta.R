...
#'
#' @description Sets the epidemic parameters for a atlanta based stochastic network model
...
#' @export
#'
param_atlanta_msm <- function(nwstats,
                      race.method = 1,
                      
                      #Set for initialized testing histories
                      last.neg.test.B.int = 224,
                      last.neg.test.W.int = 224,
                      mean.test.B.int = 224,
                      mean.test.W.int = 224,
                      ...
                      tt.B.NO.Reg.Rk = c(0.38,0.46,0.16),
                      tt.W.NO.Reg.Rk = c(0.38,0.46,0.16),
                      ...
                      mean.test.B.opp.prob = 0.629,
                      mean.test.W.opp.prob = 0.629,
                      ...
                      mean.test.B.low.int = 224,
                      mean.test.B.high.int = 224,
                     ...
                     mean.test.risk.AI.known.sd.B.prob = 0.520,
                     mean.test.risk.AI.known.sd.W.prob = 0.520,
                     ...
                     tt.traj.B.prob = c(0.035, 0.000, 0.3545, 0.6105),
                     tt.traj.W.prob = c(0.035, 0.000, 0.3545, 0.6105),

                     tx.init.B.prob = 0.1095,
                     tx.init.W.prob = 0.1095,
                     tx.halt.B.prob = 0.0087,
                     tx.halt.W.prob = 0.0087,
                     tx.reinit.B.prob = 0.00179,
                     tx.reinit.W.prob = 0.00179,
                     ...
                     disc.outset.main.B.prob = 0.787,
                     disc.outset.main.W.prob = 0.787,
                     disc.at.diag.main.B.prob = 1,
                     disc.at.diag.main.W.prob = 1,
                     disc.post.diag.main.B.prob = 0,
                     disc.post.diag.main.W.prob = 0,
                     disc.outset.pers.B.prob = 0.678,
                     disc.outset.pers.W.prob = 0.678,
                     disc.at.diag.pers.B.prob = 1,
                     disc.at.diag.pers.W.prob = 1,
                     disc.post.diag.pers.B.prob = 0,
                     disc.post.diag.pers.W.prob = 0,
                     disc.inst.B.prob = 0.568,
                     disc.inst.W.prob = 0.568,
                     
                     circ.B.prob = 0.896,
                     circ.W.prob = 0.896,

                     ccr5.B.prob = c(0.011,0.105),
                     ccr5.W.prob = c(0.011,0.105),
                     ccr5.heteroz.rr = 0.3,

                      num.inst.ai.classes = 5,
                     base.ai.main.BB.rate = 1.39 / 7,
                     base.ai.main.BW.rate = 1.39 / 7,
                     base.ai.main.WW.rate = 1.39 / 7,
                     ...
                     cond.main.WW.prob = 0.26,
                     cond.pers.BB.prob = 0.25,
                     cond.pers.BW.prob = 0.25,
                     cond.pers.WW.prob = 0.25,
                     cond.inst.BB.prob = 0.35,
                     cond.inst.BW.prob = 0.35,
                     cond.inst.WW.prob = 0.35,
