...
#'              for purpose of HIV/STI prevention intervention targeting.
#'
...
riskhist_msm <- function(dat, at) {
  ...
  if (at < min(dat$param$riskh.start,
               dat$param$riskh.stitest.start,
               dat$param$riskh.ept.start)) {
    return(dat)
  }
  ...
  part.liststi1 <-
    part.list[which((at - dat$attr$last.tx.time.rct[part.list[, "uid1"]]) <= sti.highrisktest.int |
                    ...
                    (at - dat$attr$last.tx.time.syph[part.list[, "uid1"]]) <= sti.highrisktest.int), ,
              drop = FALSE]
  ...
  part.liststi2 <-
    part.list[which((at - dat$attr$last.tx.time.rct[part.list[, "uid2"]]) <= sti.highrisktest.int |
                    ...
                    (at - dat$attr$last.tx.time.syph[part.list[, "uid2"]]) <= sti.highrisktest.int), ,
              drop = FALSE]
  ...
  part.listept1.main.short <- part.list[which((at - eptEligdate[part.list[, "uid1"]]) <= ept.risk.int &
                                            ...
                                            eptStat[part.list[, "uid1"]] == 1 & part.list[, "ptype"] == 1 &
                                              (at - part.list[, "last.active.time"]) <= 20), , drop = FALSE]
  ...
  part.listept1.main.med <- part.list[which((at - eptEligdate[part.list[, "uid1"]]) <= ept.risk.int &
                                          ((rGC.tx[part.list[, "uid2"]]) %in% c(0, NA) |
                                           ...
                                           (uCT.tx.prep[part.list[, "uid2"]]) %in% c(0, NA)) &
                                          eptStat[part.list[, "uid1"]] == 1 & part.list[, "ptype"] == 1 &
                                            (at - part.list[, "last.active.time"]) >= 21 &
  ...
  part.listept1.main.long <- part.list[which((at - eptEligdate[part.list[, "uid1"]]) <= ept.risk.int &
                                          ((rGC.tx[part.list[, "uid2"]]) %in% c(0, NA) |
                                             ...
                                             (uCT.tx.prep[part.list[, "uid2"]]) %in% c(0, NA)) &
                                             eptStat[part.list[, "uid1"]] == 1 & part.list[, "ptype"] == 1 &
                                            (at - part.list[, "last.active.time"]) >= 41 &
