...
tx.mard <- function(dat, at) {
  ...
  # Parameters
  prob.tx.init.B <- dat$param$prob.tx.init.B
  prob.tx.init.W <- dat$param$prob.tx.init.W
  prob.tx.halt.B <- dat$param$prob.tx.halt.B
  prob.tx.halt.W <- dat$param$prob.tx.halt.W
  prob.tx.reinit.B <- dat$param$prob.tx.reinit.B
  prob.tx.reinit.W <- dat$param$prob.tx.reinit.W
