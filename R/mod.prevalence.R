...
#' @export
#'
prevalence_msm_ept <- function(dat, at) {
  ...
  dat$epi$ir100[at] <- ifelse(sum(status == 0,dat$epi$incid[at], na.rm = TRUE) > 0,
                              (dat$epi$incid[at] /
                                 sum(status == 0,dat$epi$incid[at], na.rm = TRUE)) * 5200, 0)
  ...
  dat$epi$prev.gcct.tttraj1[at] <- ifelse((dat$epi$tt.traj.gc1[at] == 0 | is.na(dat$epi$tt.traj.gc1[at]) |
                                             is.nan(dat$epi$tt.traj.gc1[at]) | is.null(dat$epi$tt.traj.gc1[at]) |
                                             dat$epi$tt.traj.ct1[at] == 0 | is.na(dat$epi$tt.traj.ct1[at]) |
                                          ...
                                          sum((rGC == 1 | uGC == 1 | rCT == 1 | uCT == 1) &
                                            ...
                                            (dat$epi$tt.traj.gc1[at] + dat$epi$tt.traj.ct1[at]))
  dat$epi$prev.gcct.tttraj2[at] <- ifelse((dat$epi$tt.traj.gc2[at] == 0 | is.na(dat$epi$tt.traj.gc2[at]) |
                                             is.nan(dat$epi$tt.traj.gc2[at]) | is.null(dat$epi$tt.traj.gc2[at]) |
                                             dat$epi$tt.traj.ct2[at] == 0 | is.na(dat$epi$tt.traj.ct2[at]) |
                                          ...
                                          sum((rGC == 1 | uGC == 1 | rCT == 1 | uCT == 1) &
                                            ...
                                            (dat$epi$tt.traj.gc2[at] + dat$epi$tt.traj.ct2[at]))
  ...
  # Gonorrhea
  dat$epi$ir100.rgc[at] <- ifelse(sum(rGC == 0, dat$epi$incid.rgc[at], na.rm = TRUE) > 0,
                                  (dat$epi$incid.rgc[at] / sum(rGC == 0, dat$epi$incid.rgc[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ugc[at] <- ifelse(sum(uGC == 0, dat$epi$incid.ugc[at], na.rm = TRUE) > 0,
                                  (dat$epi$incid.ugc[at] / sum(uGC == 0, dat$epi$incid.ugc[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.gc[at] <- dat$epi$ir100.rgc[at] + dat$epi$ir100.ugc[at]

  ir100.rgc.hivneg <- ifelse(sum(rGC == 0 & status == 0, dat$epi$incid.rgc.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.rgc.hivneg[at] / sum(rGC == 0 & status == 0, dat$epi$incid.rgc.hivneg[at], na.rm = TRUE)) * 5200, 0)
  ir100.ugc.hivneg <- ifelse(sum(uGC == 0 & status == 0, dat$epi$incid.ugc.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.ugc.hivneg[at] / sum(uGC == 0 & status == 0, dat$epi$incid.ugc.hivneg[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.gc.hivneg[at] <- ir100.rgc.hivneg + ir100.ugc.hivneg

  ir100.rgc.hivpos <- ifelse(sum(rGC == 0 & status == 1, na.rm = TRUE) > 0,
                             (dat$epi$incid.rgc.hivpos[at] / sum(rGC == 0 & status == 1, na.rm = TRUE)) * 5200, 0)
  ir100.ugc.hivpos <- ifelse(sum(uGC == 0 & status == 1, dat$epi$incid.ugc.hivpos[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.ugc.hivpos[at] / sum(uGC == 0 & status == 1, dat$epi$incid.ugc.hivpos[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.gc.hivpos[at] <- ir100.rgc.hivpos + ir100.ugc.hivpos

  ir100.rgc.tttraj1 <- ifelse(sum(rGC == 0 & (tt.traj.gc.hivneg == 1 | tt.traj.gc.hivpos == 1), dat$epi$incid.rgc.tttraj1[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.rgc.tttraj1[at] / sum(rGC == 0 & (tt.traj.gc.hivneg == 1 | tt.traj.gc.hivpos == 1),
                                                                   dat$epi$incid.rgc.tttraj1[at], na.rm = TRUE)) * 5100, 0)
  ir100.ugc.tttraj1 <- ifelse(sum(uGC == 0 & (tt.traj.gc.hivneg == 1 | tt.traj.gc.hivpos == 1), dat$epi$incid.ugc.tttraj1[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.ugc.tttraj1[at] / sum(uGC == 0 & (tt.traj.gc.hivneg == 1 | tt.traj.gc.hivpos == 1),
                                                                   dat$epi$incid.ugc.tttraj1[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.gc.tttraj1[at] <- ir100.rgc.tttraj1 + ir100.ugc.tttraj1

  ir100.rgc.tttraj2 <- ifelse(sum(rGC == 0 & (tt.traj.gc.hivneg == 2 | tt.traj.gc.hivpos == 2), dat$epi$incid.rgc.tttraj2[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.rgc.tttraj2[at] / sum(rGC == 0 & (tt.traj.gc.hivneg == 2 | tt.traj.gc.hivpos == 2),
                                                                   dat$epi$incid.rgc.tttraj2[at], na.rm = TRUE)) * 5200, 0)
  ir100.ugc.tttraj2 <- ifelse(sum(uGC == 0 & (tt.traj.gc.hivneg == 2 | tt.traj.gc.hivpos == 2), dat$epi$incid.ugc.tttraj2[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.ugc.tttraj2[at] / sum(uGC == 0 & (tt.traj.gc.hivneg == 2 | tt.traj.gc.hivpos == 2),
                                                                   dat$epi$incid.ugc.tttraj2[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.gc.tttraj2[at] <- ir100.rgc.tttraj2 + ir100.ugc.tttraj2

  # Chlamydia
  dat$epi$ir100.rct[at] <- ifelse(sum(rCT == 0, dat$epi$incid.rct[at], na.rm = TRUE) > 0,
                                  (dat$epi$incid.rct[at] / sum(rCT == 0, dat$epi$incid.rct[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.uct[at] <- ifelse(sum(uCT == 0, dat$epi$incid.uct[at], na.rm = TRUE) > 0,
                                  (dat$epi$incid.uct[at] / sum(uCT == 0, dat$epi$incid.uct[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ct[at] <- dat$epi$ir100.rct[at] + dat$epi$ir100.uct[at]

  ir100.rct.hivneg <- ifelse(sum(rCT == 0 & status == 0, dat$epi$incid.rct.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.rct.hivneg[at] / sum(rCT == 0 & status == 0, dat$epi$incid.rct.hivneg[at], na.rm = TRUE)) * 5200, 0)
  ir100.uct.hivneg <- ifelse(sum(uCT == 0 & status == 0, dat$epi$incid.uct.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.uct.hivneg[at] / sum(uCT == 0 & status == 0, dat$epi$incid.uct.hivneg[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ct.hivneg[at] <- ir100.rct.hivneg + ir100.uct.hivneg

  ir100.rct.hivpos <- ifelse(sum(rCT == 0 & status == 1, dat$epi$incid.rct.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.rct.hivneg[at] / sum(rCT == 0 & status == 1, dat$epi$incid.rct.hivneg[at], na.rm = TRUE)) * 5200, 0)
  ir100.uct.hivpos <- ifelse(sum(uCT == 0 & status == 1, dat$epi$incid.uct.hivneg[at], na.rm = TRUE) > 0,
                             (dat$epi$incid.uct.hivneg[at] / sum(uCT == 0 & status == 1, dat$epi$incid.uct.hivneg[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ct.hivpos[at] <- ir100.rct.hivpos + ir100.uct.hivpos

  ir100.rct.tttraj1 <- ifelse(sum(rCT == 0 & (tt.traj.ct.hivneg == 1 | tt.traj.ct.hivpos == 1), dat$epi$incid.rct.tttraj1[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.rct.tttraj1[at] / sum(rCT == 0 & (tt.traj.ct.hivneg == 1 | tt.traj.ct.hivpos == 1),
                                                                   dat$epi$incid.rct.tttraj1[at], na.rm = TRUE)) * 5100, 0)
  ir100.uct.tttraj1 <- ifelse(sum(uCT == 0 & (tt.traj.ct.hivneg == 1 | tt.traj.ct.hivpos == 1), dat$epi$incid.uct.tttraj1[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.uct.tttraj1[at] / sum(uCT == 0 & (tt.traj.ct.hivneg == 1 | tt.traj.ct.hivpos == 1),
                                                                   dat$epi$incid.uct.tttraj1[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ct.tttraj1[at] <- ir100.rct.tttraj1 + ir100.uct.tttraj1

  ir100.rct.tttraj2 <- ifelse(sum(rCT == 0 & (tt.traj.ct.hivneg == 2 | tt.traj.ct.hivpos == 2), dat$epi$incid.rct.tttraj2[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.rct.tttraj2[at] / sum(rCT == 0 & (tt.traj.ct.hivneg == 2 | tt.traj.ct.hivpos == 2),
                                                                   dat$epi$incid.rct.tttraj2[at], na.rm = TRUE)) * 5200, 0)
  ir100.uct.tttraj2 <- ifelse(sum(uCT == 0 & (tt.traj.ct.hivneg == 2 | tt.traj.ct.hivpos == 2), dat$epi$incid.uct.tttraj2[at], na.rm = TRUE) > 0,
                              (dat$epi$incid.uct.tttraj2[at] / sum(uCT == 0 & (tt.traj.ct.hivneg == 2 | tt.traj.ct.hivpos == 2),
                                                                   dat$epi$incid.uct.tttraj2[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.ct.tttraj2[at] <- ir100.rct.tttraj2 + ir100.uct.tttraj2

  # dat$epi$ir100.syph[at] <- ifelse(sum(syphilis == 0, dat$epi$incid.syph[at], na.rm = TRUE) > 0,
  #                                  (dat$epi$incid.syph[at] / sum(syphilis == 0, dat$epi$incid.syph[at], na.rm = TRUE)) * 5200, 0)

  # Combined GC/CT Incidence
  dat$epi$ir100.gcct[at] <- dat$epi$ir100.gc[at] + dat$epi$ir100.ct[at]
  dat$epi$ir100.gcct.tttraj1[at] <- dat$epi$ir100.gc.tttraj1[at] + dat$epi$ir100.ct.tttraj1[at]
  dat$epi$ir100.gcct.tttraj2[at] <- dat$epi$ir100.gc.tttraj2[at] + dat$epi$ir100.ct.tttraj2[at]

  # All STI Incidence
  dat$epi$ir100.sti[at] <- dat$epi$ir100.gc[at] + dat$epi$ir100.ct[at] + dat$epi$ir100.syph[at]
  dat$epi$ir100.sti.tttraj1[at] <- dat$epi$ir100.gc.tttraj1[at] + dat$epi$ir100.ct.tttraj1[at] + dat$epi$ir100.syph.tttraj1[at]
  dat$epi$ir100.sti.tttraj2[at] <- dat$epi$ir100.gc.tttraj2[at] + dat$epi$ir100.ct.tttraj2[at] + dat$epi$ir100.syph.tttraj2[at]
...
#' @export
#'
prevalence_msm_tnt <- function(dat, at) {
...
prevalence_msm <- function(dat, at) {
  ...
  if (at == 1) {
    ...
    dat$epi$incid.rgc.hivneg <- rNA
    dat$epi$incid.ugc.hivneg <- rNA
    dat$epi$incid.rgc.hivpos <- rNA
    dat$epi$incid.ugc.hivpos <- rNA
    dat$epi$incid.rct.hivneg <- rNA
    dat$epi$incid.uct.hivneg <- rNA
    dat$epi$incid.rct.hivpos <- rNA
    dat$epi$incid.uct.hivpos <- rNA
  ...
  dat$epi$prev.hiv.primsecosyphneg[at] <- ifelse(length(which(stage.syph %in% c(1, 2, 3))) > 0,
                                            length(intersect(which(status == 0), which(stage.syph %in% c(1, 2, 3)))) / length(which(stage.syph %in% c(1, 2, 3))), 0)
  ...
  dat$epi$ir100.syph.tttraj1[at] <- ifelse((sum(syphilis == 0 & (tt.traj.syph.hivneg == 1 | tt.traj.syph.hivpos == 1), dat$epi$incid.syph.tttraj1[at], na.rm = TRUE)) > 0,
                                         (dat$epi$incid.syph.tttraj1[at] /
                                            (sum(syphilis == 0 & (tt.traj.syph.hivneg == 1 | tt.traj.syph.hivpos == 1), dat$epi$incid.syph.tttraj1[at], na.rm = TRUE))) * 5200, 0)

  dat$epi$ir100.syph.tttraj2[at] <- ifelse((sum(syphilis == 0 & (tt.traj.syph.hivneg == 2 | tt.traj.syph.hivpos == 2), dat$epi$incid.syph.tttraj2[at], na.rm = TRUE)) > 0,
                                           (dat$epi$incid.syph.tttraj2[at] /
                                              (sum(syphilis == 0 & (tt.traj.syph.hivneg == 2 | tt.traj.syph.hivpos == 2), dat$epi$incid.syph.tttraj2[at], na.rm = TRUE))) * 5200, 0)

  dat$epi$ir100.gc.tttraj1[at] <- ir100.rgc.tttraj1 + ir100.ugc.tttraj1

  dat$epi$ir100.syph.hivneg[at] <- ifelse(sum(syphilis == 0 & status == 0, dat$epi$incid.syph.hivneg[at], na.rm = TRUE) > 0,
                                          (dat$epi$incid.syph.hivneg[at] / sum(syphilis == 0 & status == 0, dat$epi$incid.syph.hivneg[at], na.rm = TRUE)) * 5200, 0)
  dat$epi$ir100.syph.hivpos[at] <- ifelse(sum(syphilis == 0 & status == 1, dat$epi$incid.syph.hivpos[at], na.rm = TRUE) > 0,
                                          (dat$epi$incid.syph.hivpos[at] / sum(syphilis == 0 & status == 1, dat$epi$incid.syph.hivpos[at], na.rm = TRUE)) * 5200, 0)
